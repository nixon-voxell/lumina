        ...
        #stack(
          ...
          rect(
            ...
            // Add red rectangle as booster overheat signal
             #place(top + left, rect(width: red_height*100%, height: 100% * 100%, fill: rgb("EC6F59").saturate(30%)
          ))
        ]
        )
      ],
...
#let playerhealth(current_hp, max_hp, rect_width: 21pt, rect_height: 31pt, spacing: 8pt) = {
...
#let main(main_width, main_height, boostmeter, timer, health, weapon_selector, score_bar) = context {
